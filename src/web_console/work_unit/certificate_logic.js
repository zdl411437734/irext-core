...
var MD5 = require('../mini-poem/security/md5.js');
var StringUtils = require('../mini-poem/utils/string_utils.js');
...
var adminAuth = new AdminAuth(MEMCACHED_HOST, MEMCACHED_PORT, MEMCACHED_SASL_USER, MEMCACHED_SASL_PASSWORD);
