...
// ÐÞ¸Ä---amomcu---------2015.08.31----  
// °¢Äªµ¥Æ¬»úÌÔ±¦µê  https://amomcu.taobao.com/  
...
// Simple Profile Characteristic 6 Properties ¿É¶Á£¬¿ÉÐ´£¬ ¿ÉÍ¨Öª
static uint8 simpleProfileChar6Props = GATT_PROP_READ | GATT_PROP_WRITE_NO_RSP | GATT_PROP_NOTIFY;

// Characteristic 6 Value
static uint8 simpleProfileChar6[SIMPLEPROFILE_CHAR6_LEN] = {0};// ÌØÕ÷Öµ³õÊ¼»¯
...
static uint8 simpleProfileChar6UserDesp[17] = "Characteristic 6";  // ÌØÕ÷ÖµÃèÊö
/*********************************************************************
